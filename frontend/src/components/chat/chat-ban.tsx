...
// Updated validation schema for the Ban feature
...
type BanData = z.infer<typeof BanSchema>;
...
export const BanSelector: React.FC<BanSelectorProps> = ({
  targetUser,
  conversationId,
  onClose,
}) => {
    ...
    <AlertDialog open={true}>
      <AlertDialogContent>
        <AlertDialogHeader className="flex flex-col items-center">
          <AlertDialogTitle>Ban {targetUser.username}</AlertDialogTitle>
        </AlertDialogHeader>
          ...
          <form>
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500 text-center mt-2">
                Leaving all values at <strong>0</strong> will make the Ban
                permanent.
              </p>
            </div>
