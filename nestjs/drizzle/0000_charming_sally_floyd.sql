...
CREATE TABLE "conversation_participants_user" (
	"conversationId" uuid NOT NULL,
	"userId" integer NOT NULL,
	CONSTRAINT "PK_25e9241137cdb0f2336d267cc99" PRIMARY KEY("conversationId","userId")
);
--> statement-breakpoint
...
ALTER TABLE "conversation_participants_user" ADD CONSTRAINT "FK_4928ef292e3fb48783034b82f7a" FOREIGN KEY ("conversationId") REFERENCES "public"."conversation"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "conversation_participants_user" ADD CONSTRAINT "FK_5d93fb1843f96fbdefea37dae86" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "IDX_c755e3741cd46fc5ae3ef06592" ON "user_achievements" USING btree ("user_id" int4_ops);--> statement-breakpoint
CREATE INDEX "IDX_4928ef292e3fb48783034b82f7" ON "conversation_participants_user" USING btree ("conversationId" uuid_ops);--> statement-breakpoint
CREATE INDEX "IDX_5d93fb1843f96fbdefea37dae8" ON "conversation_participants_user" USING btree ("userId" int4_ops);
*/